	...
	<div id="middle">
		<form action="${pageContext.request.contextPath}/user/login" method="post">
			<ul style="text-align: center;">
				...
				<li><input class="name" name="username" value="aaa" placeholder="请输入用户名" style="margin-top: 25px;"></li>
				<li><input type="password" name="password" class="pwd"placeholder="请输入密码" value="123456"></li>
				<li id="verifyCode" style="display: block;">
				<input id="valid"name="rand" placeholder="请输入验证码" maxlength="4" value="1111"> 
				<span id="validcode">
					<img id="image" id="img_captcha"src="">
				</span> 
